...
LOCAL_ADDRESS.each do |address|
  ...
  report.report_date_time = Date.today
  report.address = address
  report.latitude = 40.0
  report.longitude = 6.0
  report.save
  reports << report
end
...
random_users.each do |user|
  ...
  report.report_date_time = Date.today
  report.address = "*"
  report.latitude = Faker::Address.latitude
  report.longitude = Faker::Address.longitude
  report.save
  reports << report
end
